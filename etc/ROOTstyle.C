
{
  ...
  tfboost_style->SetLegendTextSize(scale*0.054);
  tfboost_style->SetPalette(1);
  tfboost_style->SetPalette(8,colors);
  tfboost_style->SetPaperSize(20,26);
  
  tfboost_style->SetPadTopMargin(0.10);
  tfboost_style->SetPadRightMargin(0.10);
  tfboost_style->SetPadBottomMargin(0.10);
  tfboost_style->SetPadLeftMargin(0.13);
  ...
  tfboost_style->SetLabelSize(scale*0.054,"x");
  tfboost_style->SetLabelSize(scale*0.054,"y");
  tfboost_style->SetLabelSize(scale*0.054,"z");
  ...
  tfboost_style->SetTitleSize(scale*0.054,"x");
  tfboost_style->SetTitleSize(scale*0.054,"y");
  tfboost_style->SetTitleSize(scale*0.054,"z");
  tfboost_style->SetLineWidth((Width_t)1.8);
  tfboost_style->SetFrameLineWidth((Width_t)1.8);
  tfboost_style->SetHistLineWidth((Width_t)1.8);
  tfboost_style->SetFuncWidth((Width_t)1.8);
  tfboost_style->SetGridWidth((Width_t)1.8);
  ...
  tfboost_style->SetTitleOffset(1.2,"Y");
  ...
  tfboost_style->SetStatFontSize(0.01);
  
  tfboost_style->SetStatX(0.84);
  tfboost_style->SetStatY(0.84);
  tfboost_style->SetStatW(0.30);
  tfboost_style->SetStatH(0.01);
